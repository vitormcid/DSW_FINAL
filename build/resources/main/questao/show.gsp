...
<html>
    ...
    <body>
        ...
        <div id="show-questao" class="content scaffold-show" role="main">
            ...
            <f:display bean="questao" />
            <g:form resource="${this.questao}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.questao}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
